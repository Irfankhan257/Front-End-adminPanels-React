...
<header className="text-gray-600 body-font fixed top-0 w-full z-10 bg-transparent backdrop-filter backdrop-blur-md mx-9 rounded-4xl ">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
    <img className="w-20 h-14 object-contain" alt="hero" src={logo}/>
...
<section className="text-gray-600 body-font bg-gradient-to-l from-black-950 from-10% via-slate-900 via-30% to-teal-500 to-90%"  >
  <div className="container mx-auto flex px-5 py-48 md:flex-row flex-col items-center animate-fade-in-and-up ">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-fill rounded spinning-image w-full h-full" alt="hero" src={logo}/>
    </div>
  </div>
</section>
    ...
    <div className="flex flex-wrap -mx-4 -mb-10 text-center">
      <div className="sm:w-1/2 mb-10 px-4">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-contain object-center h-full w-full" src={innovator} />
        </div>
        <h2 className="title-font text-3xl font-medium text-gray-400 mt-6 mb-3">Innovators</h2>
      ...
      <div className="sm:w-1/2 mb-10 px-4">
        <div className="rounded-lg h-64 overflow-hidden">
          <img alt="content" className="object-contain object-center h-full w-full" src={investor} />
        </div>
        <h2 className="title-font text-3xl font-medium text-gray-400 mt-6 mb-3">Investor</h2>
        <p className="leading-relaxed text-base text-gray-400 ">Williamsburg occupy sustainable snackwave gochujang. Pinterest cornhole brunch, slow-carb neutra irony.</p>
        <button className="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
      </div>
    </div>
