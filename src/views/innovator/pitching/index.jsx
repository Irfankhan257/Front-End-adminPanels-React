...
const PitchingIdeas = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      //   tags: tags.filter((tag) => tag.id === parseInt(selectedTag)),
      userId: user.id,
    };

    console.log(payload);
    try {
      const addIdea = PitchingIdeasController.PostIdea(payload);
      console.log(addIdea);
    } catch {
      console.error("Idea failed:", error.message);
    }
  };
      ...
      <div className="col-span-1 my-7 flex  w-full items-start justify-center pt-16 xl:col-span-1 2xl:col-span-2 ">
        <div className="w-full max-w-[420px] rounded-lg  p-6 shadow-md">
          ...
          <p className="mb-6 text-center text-base text-gray-600">
            ...
            description on what your idea is and how it will help the world with
            some investment!
          </p>
